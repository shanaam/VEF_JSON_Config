...
public class ExperimentContainer
{
    ...
    // manually in this class if we want to check specific types other than the ones specified 
    ...
    /// </summary>
    /// <param name="key"></param>
    /// <returns>A default value depending on the type of key.
    /// Integer -> 0
    /// String -> ""
    /// Bool -> false
    /// float -> 0.0f</returns>
    ...
    /// <returns>The value of the input in its correct type. 
    /// Whole numbers -> int. 
    /// Numbers with a decimal -> float
    /// The words "true" or "false" -> bool
    /// Anything else -> string</returns>
